...
This repository is for teaching materials for Chapter 4 of Anderson Woessner and Hunt (2015).  It again uses the Python Notebook approach for creating and exploring the problems in the book.  Instructions for minimum iPython Notebook installation are found here at http://ipython.org/install.html.  In addition, the problems have gone beyond simple problems and now we use MODFLOW to solve the groundwater problem.  These notebooks use "flopy" to do illustrate modeling concepts (http://modflowpy.github.io/flopydoc/index.html). The flopy software configuration are available from http://modflowpy.github.io/flopydoc/introduction.html#flopy-installation.   
